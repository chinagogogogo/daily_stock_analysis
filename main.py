...
示例:
  ...
  python main.py --stocks 601600,300503,300260,01810,518880,562910,601628,300724,159770,300001,603688,159665,601799,600519,09988,603527,688721,02367,000001  # 指定分析特定股票
